         ...
         <div className="flex justify-center items-center">
             <form action="https://getform.io/f/0d6a567f-f7f0-41ab-bf64-fc7d4f8ef866" method="POST" className="flex flex-col w-full md:w-1/2">
                 ...
                 text-white focus:outline-none">
                    ...
                    <button className="group text-white w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from bg-white to to-gray-400 cursor-pointer hover:scale-105">Send</button>
                 ...
                 hover:scale-110 duration-300">Lets Talk</button> */}
             </form>
         </div>
     </div>
 </div>
